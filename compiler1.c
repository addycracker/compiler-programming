...
bool valididentifier(char* str){
        if (str[0] == '0' || str[0] == '1' ||  str[0] == '2' ||  str[0] == '3' ||  str[0] == '4' ||  str[0] == '5' ||  str[0] == '6' ||  str[0] == '6' ||  str[0] == '7' ||  str[0] == '8' || str[0] == '9' || isDelimeter(str[0]) == true )
                return (false);
        return(true);
}
// Returns 'true' if the string is KEYWORD
...
void parse(char* str)
{
        ...
        while(right <= len && left <= right){
                ...
                if(isDelimeter(str[right]) == true && left == right){
                        ...
                        else if(valididentifier(subStr) == true && isDelimeter(str[right-1]) == false)
                                printf("'%s' IS A VALID IDENTIFIER \n",subStr);
                        else if(valididentifier(subStr) == false && isDelimeter(str[right-1]) == false)
...
int main()
{
        ...
        parse(str);//calling parse function
